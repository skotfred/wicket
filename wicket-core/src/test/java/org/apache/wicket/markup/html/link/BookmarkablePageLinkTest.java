...
class BookmarkablePageLinkTest extends WicketTestCase
{
	...
	void customParametersWithSpecialCharacters()
	{
		...
		assertEquals(
			"<html lang=\"en\"><body><span wicket:id=\"link\" onclick=\"var win = this.ownerDocument.defaultView || this.ownerDocument.parentWindow; if (win == window) { window.location.href=&#039;./bookmarkable/org.apache.wicket.MockPageWithLink?urlEscapeNeeded=someone%27s+%5Eb%25a%26d+pa%22rameter&#039;; } ;return false\"></span></body></html>",
			response);
	}
}
